...
func (c *Client) GetAllRoles(
...
) (envsyncgosdk.RolesResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response envsyncgosdk.RolesResponse
...
func (c *Client) CreateRole(
	ctx context.Context,
	request *envsyncgosdk.CreateRoleRequest,
	opts ...option.RequestOption,
) (*envsyncgosdk.RoleResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *envsyncgosdk.RoleResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
...
func (c *Client) GetRoleStats(
	ctx context.Context,
	opts ...option.RequestOption,
) (*envsyncgosdk.RoleStatsResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *envsyncgosdk.RoleStatsResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
