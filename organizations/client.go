...
func (c *Client) GetOrg(
...
) (*envsyncgosdk.OrgResponse, error) {
	options := core.NewRequestOptions(opts...)
	...
	var response *envsyncgosdk.OrgResponse
...
func (c *Client) UpdateOrg(
	ctx context.Context,
	request *envsyncgosdk.UpdateOrgRequest,
	opts ...option.RequestOption,
) (*envsyncgosdk.OrgResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
...
func (c *Client) CheckIfSlugExists(
	ctx context.Context,
	request *envsyncgosdk.CheckIfSlugExistsRequest,
	opts ...option.RequestOption,
) (*envsyncgosdk.CheckSlugResponse, error) {
	options := core.NewRequestOptions(opts...)
	baseURL := internal.ResolveBaseURL(
		options.BaseURL,
		c.baseURL,
	...
	var response *envsyncgosdk.CheckSlugResponse
	if err := c.caller.Call(
		ctx,
		&internal.CallParams{
			URL:             endpointURL,
